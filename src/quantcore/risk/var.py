...
def value_at_risk(
    ...
    References:
        ...
        See REFERENCES.md.
    """
    _validate_returns_and_confidence(returns, confidence_level)
    return _value_at_risk(returns, confidence_level)
...
def conditional_value_at_risk(
    ...
    """
    _validate_returns_and_confidence(returns, confidence_level)
    return _conditional_value_at_risk(returns, confidence_level)
